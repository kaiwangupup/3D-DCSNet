...
def fetch_batch_pix3d(models, batch_num, batch_size):
	...
	for ind in xrange(batch_num*batch_size,batch_num*batch_size+batch_size):
		...
		pcl_path_1K = join(FLAGS.data_dir_pcl, model_path,'pcl_%d%s.npy'%(1024,model_name))
...
if __name__ == '__main__':
	...
	#pcl_gt = sample(2048, pcl_gt)  #equals to :outputs = gather_point(outputs, farthest_point_sample(2048, outputs)) 
